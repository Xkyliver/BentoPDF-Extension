document.addEventListener('DOMContentLoaded', function() {
    ...
    const rawToolsData = {
        ...
        "Convert to PDF": [
            ...
            "Text to PDF", "Markdown to PDF", "JSON to PDF", "ODT to PDF",
            "CSV to PDF", "RTF to PDF", "Word to PDF", "Excel to PDF", 
            "PowerPoint to PDF", "XPS to PDF", "MOBI to PDF", "EPUB to PDF",
            "FB2 to PDF", "CBZ to PDF", "WPD to PDF", "WPS to PDF", "XML to PDF",
            "Pages to PDF", "ODG to PDF", "ODS to PDF", "ODP to PDF", "PUB to PDF",
            "VSD to PDF", "PSD to PDF", "Email to PDF"
        ],
        "Convert from PDF": [
        ...
        "Organize & Manage": [
            ...
            "N-Up PDF", "PDF Booklet", "Combine to Single Page", "View Metadata", "Edit Metadata", 
            "PDFs to ZIP", "Compare PDFs", "Posterize PDF"
        ],
        "Optimize & Repair": [
            "Compress PDF", "PDF to PDF/A", "Fix Page Size", "Linearize PDF", "Page Dimensions",
            "Remove Restrictions", "Repair PDF", "Rasterize to PDF", "Deskew PDF","Font to Outline"
        ],
        "Secure PDF": [
            "Encrypt PDF", "Sanitize PDF", "Decrypt PDF", "Flatten PDF", 
            "Remove Metadata", "Change Permissions", "Digital Signature PDF","Validate PDF Signature"
        ]
    };
    ...
    const urlOverrides = {
        ...
        "rasterize to pdf": "rasterize-pdf",
